...
if (
    ...
    && !in_array( 'woo-vietnam-checkout/woo-vietnam-checkout.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
    && !in_array( 'devvn-woo-ghtk/devvn-woo-ghtk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
    && !in_array( 'devvn-woo-ghn/devvn-woo-ghn.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
    && !in_array( 'devvn-woo-vnpost/devvn-woo-vnpost.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) )
