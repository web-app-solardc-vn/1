...
?>
			...
			<form name="ttqr-setting-form" method="post">
				...
				<table class="form-table">
					...
					-->
						...
						<tr>
							<th scope="row"><?php echo __('Telegram Group ID', 'ttqr') ?></th>
							<td>
		...
		<!-- #wrap ->
        <?php
        do_action('ttqr_admin_page_footer');
	}
