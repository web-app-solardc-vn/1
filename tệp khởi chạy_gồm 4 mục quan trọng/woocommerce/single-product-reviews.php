...
// Kiểm tra nếu chức năng bình luận không được mở, thoát khỏi hàm
if (!comments_open()) {
    return;
}
...
<div id="reviews" class="woocommerce-Reviews">
    <div class="rating-overview-container">
        <div class="rating-average-section">
            <div class="rating-summary">
                <h4 class="average-rating"><?php 
                    // Lấy và hiển thị đánh giá trung bình của sản phẩm
                ...
                <p class="rating-count">
                    ...
                    printf(_n('%s Review', '%s Reviews', $product->get_review_count(), 'woocommerce'), 
        ...
        <div class="rating-distribution-section">
            <div class="rating-bars">
                <?php
                // Lấy và hiển thị phân bố đánh giá
    ...
    <div class="reviews-container row">
        <?php 
        // Kiểm tra nếu người dùng đã mua sản phẩm hoặc không yêu cầu xác minh
        ...
        <div id="comments" class="col large-<?php echo (get_comment_pages_count() == 0 || $tab_style == 'sections' || $tab_style == 'tabs_vertical') ? '12' : '7'; ?>">
            <h3 class="woocommerce-Reviews-title normal">
                <?php
                // Hiển thị tiêu đề phần bình luận
            ...
            <?php if ( have_comments() ) : ?>
                ...
                <?php
                // Hiển thị phân trang cho bình luận nếu có nhiều trang
